...
class SnapbotGymClass():
    ...
    def step(self,a,max_time=np.inf):
        ...
        # Other information
        info = {'h_prev': p_torso_prev[2], 'h_cur': p_torso_cur[2], 'r_height': r_height, 'r_forward':r_forward, 'hip_pen_ang': hip_pen_ang,'hip_pen_vel': hip_pen_vel, 'rollover': ROLLOVER,'self_collision': SELF_COLLISION,'r_survive': r_survive,'reward_step' : r,}
